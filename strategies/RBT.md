...
The emergency stop exists for the day a stock gaps on news — that's the one that actually
...
[`RUBBER_BAND_TRADING.md`](../RUBBER_BAND_TRADING.md) — the maths, the cointegration
